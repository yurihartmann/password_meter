...
class TestConsecutiveLowercaseLetters(unittest.TestCase):
    ...
    def test_instance(self):
        consecutive_uppercase_letters = ConsecutiveLowercaseLetters(Mock())
        self.assertIsInstance(consecutive_uppercase_letters, ConsecutiveLowercaseLetters)

    def test_method_get_count_with_consecutive_uppercase_letters_should_be_count_of_letters(self):
        consecutive_uppercase_letters = ConsecutiveLowercaseLetters(Mock())
        consecutive_uppercase_letters.password.get_value.return_value = 'aAAAddrRRrGgg'
        self.assertEqual(3, consecutive_uppercase_letters.get_count())

    def test_method_get_count_without_consecutive_uppercase_letters_should_be_zero(self):
        consecutive_uppercase_letters = ConsecutiveLowercaseLetters(Mock())
        consecutive_uppercase_letters.password.get_value.return_value = 'aAdRrGg24Df'
    ...
    def test_method_get_bonus_with_consecutive_uppercase_letters_should_bonus(self):
        consecutive_uppercase_letters = ConsecutiveLowercaseLetters(Mock())
        consecutive_uppercase_letters.password.get_value.return_value = 'aaaarrRft123HHrtyu'
        self.assertEqual(-18, consecutive_uppercase_letters.get_bonus())
